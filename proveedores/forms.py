    ...
    class Meta:
        ...
        widgets = {
            "nombre": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Nombre del proveedor", "autocomplete": "off"}
            ),
            "numero_de_cuenta": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Número de cuenta", "autocomplete": "off"}
            ),
            "opinion_de_cumplimiento": ClearableFileInput(
                attrs={"class": "form-control"}
            ),
            "razon_social": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Razón social", "autocomplete": "off"}
            ),
            "rfc": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "RFC", "autocomplete": "off"}
            ),
            ...
            "codigo_postal": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Código postal", "autocomplete": "off"}
            ),
            "caratula": ClearableFileInput(
                attrs={"class": "form-control"}
            ),
        }
...
class AddContactoProveedorForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nombre": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Nombre del contacto", "autocomplete": "off"}
            ),
