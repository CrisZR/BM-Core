...
from proveedores.models import Proveedor, ProductosProveedor
...
class OrdenDeCompra(models.Model):
    numero_de_orden = models.CharField(
        max_length=20, blank=False, null=False, verbose_name="Número de orden"
    )
    ...
    negocio = models.ForeignKey(
        "negocio.Negocio", on_delete=models.CASCADE, verbose_name="Negocio"
    )
    activo = models.BooleanField(default=True, verbose_name="Activo")
    estatus = models.CharField(
        max_length=20,
        choices=EstatusChoices.choices,
        default=EstatusChoices.PENDIENTE,
...
class ProductoEnOrden(models.Model):
    ...
    cantidad = models.PositiveIntegerField(
        blank=False, null=False, verbose_name="Cantidad"
    )
