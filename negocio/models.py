...
from proveedores.models import RegimenFiscal
...
class Negocio(models.Model):
    ...
    nombre_fiscal = models.CharField(
        max_length=100, blank=False, null=False, verbose_name="Nombre fiscal"
    )
    direccion = models.CharField(
        max_length=200, blank=False, null=False, verbose_name="Dirección"
    )
    ...
    logo = models.ImageField(
        upload_to="img/negocio/logos/", blank=True, null=True, verbose_name="Logo"
    )
