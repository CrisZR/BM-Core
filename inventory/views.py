        ...
        with transaction.atomic():
          ...
          if cantidad:
            if cantidad > 0:
              ...
              if not inventario:
                messages.error(request, "Error al crear el registro de inventario del producto.")
            ...
            try:
                with transaction.atomic():
                    ...
                    if nueva_cantidad is not None and inventario:
                        ...
                        tipo_movimiento = "ALTA" if nueva_cantidad > cantidad_anterior else "BAJA"
                        message += f" {tipo_movimiento} registrada."
